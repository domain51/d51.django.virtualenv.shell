...
setup(
    name='d51.django.virtualenv.shell',
    version='0.1',
    description='Simple package for running Django\'s shell within virtualenv',
    author='Travis Swicegood',
    author_email='development@domain51.com',
    url='http://github.com/domain51/d51.django.virtualenv.shell/',
    packages=packages,
    classifiers=[
